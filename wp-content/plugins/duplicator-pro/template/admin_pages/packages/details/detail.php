        ...
        <div class="dup-box-panel" id="dup-package-dtl-archive-panel" style="<?php echo esc_attr($ui_css_archive) ?>">
            ...
            <table class='dup-dtl-data'>
                ...
                <tr>
                    ...
                    <td><?php echo $package->Archive->FilterOn == 1 ? esc_html__('On', 'duplicator-pro') : esc_html__('Off', 'duplicator-pro'); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
            ...
            <table class='dup-dtl-data'>
                ...
                <tr>
                    <td><?php esc_html_e("Filters", 'duplicator-pro') ?>: </td>
                    <td><?php echo $package->Database->FilterOn == 1 ? esc_html__('On', 'duplicator-pro') : esc_html__('Off', 'duplicator-pro'); ?></td>
                </tr>
                <tr>
                    <td> </td>
                    <td>
