...
class RetryMiddleware
{
     ...
     */
    public function __construct(callable $decider, callable $nextHandler, $delay = null)
    {
     ...
     * @return self
     */
    private function doRetry(RequestInterface $request, array $options, $response = null)
    {
