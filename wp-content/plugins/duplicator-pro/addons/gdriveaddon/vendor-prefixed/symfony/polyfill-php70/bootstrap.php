...
if (!\function_exists('intdiv') && !\function_exists('VendorDuplicator\intdiv')) {
    function intdiv($num1, $num2)
    {
        return p\Php70::intdiv($num1, $num2);
    }
}
if (!\function_exists('preg_replace_callback_array') && !\function_exists('VendorDuplicator\preg_replace_callback_array')) {
...
if (!\function_exists('error_clear_last') && !\function_exists('VendorDuplicator\error_clear_last')) {
