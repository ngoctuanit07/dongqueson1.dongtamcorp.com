...
class RequestException extends TransferException
{
    ...
    public function __construct($message, RequestInterface $request, $response = null, $previous = null, array $handlerContext = [])
    {
     ...
     * @return self
     */
    public static function create(RequestInterface $request, $response = null, $previous = null, array $ctx = [])
    {
        if (!$response) {
