...
class Client
{
     ...
     */
    public function __construct($accessToken, $client = null, $maxChunkSize = self::MAX_CHUNK_SIZE, $maxUploadChunkRetries = 0)
    {
    ...
    public function rpcEndpointRequest($endpoint, $parameters = null)
    {
        try {
