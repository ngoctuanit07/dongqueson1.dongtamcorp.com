...
if (\PHP_VERSION_ID < 70400) {
    if (!\function_exists('\\VendorDuplicator\\idn_to_ascii') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\idn_to_ascii')) {
    ...
    if (!\function_exists('\\VendorDuplicator\\idn_to_utf8') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\idn_to_utf8')) {
