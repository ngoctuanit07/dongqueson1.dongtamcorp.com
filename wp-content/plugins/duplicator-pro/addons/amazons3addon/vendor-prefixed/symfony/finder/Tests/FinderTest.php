 ...
 */
namespace VendorDuplicator\Symfony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('VendorDuplicator\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('VendorDuplicator\Symfony\Component\Finder\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (\false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'VendorDuplicator\Symfony\Component\Finder\Exception\AccessDeniedException';
