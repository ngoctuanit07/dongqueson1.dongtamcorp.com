...
if ('\\' === \DIRECTORY_SEPARATOR && (!\function_exists('\\VendorDuplicator\\sapi_windows_vt100_support') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\sapi_windows_vt100_support'))) {
    function sapi_windows_vt100_support($stream, $enable = null)
    {
        return p\Php72::sapi_windows_vt100_support($stream, $enable);
    }
}
if (!\function_exists('\\VendorDuplicator\\stream_isatty') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\stream_isatty')) {
    function stream_isatty($stream)
    {
        return p\Php72::stream_isatty($stream);
    }
}
if (!\function_exists('\\VendorDuplicator\\utf8_encode') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\utf8_encode')) {
    function utf8_encode($string)
    {
        return p\Php72::utf8_encode($string);
    }
}
if (!\function_exists('\\VendorDuplicator\\utf8_decode') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\utf8_decode')) {
    function utf8_decode($string)
    {
        return p\Php72::utf8_decode($string);
    }
}
if (!\function_exists('\\VendorDuplicator\\spl_object_id') && !\function_exists('\\VendorDuplicator\\VendorDuplicator\spl_object_id')) {
