...
class CapMng
{
    ...
    */
     ...
     */
    protected static function realCanCheck($cap, $thow = true)
    {
        /**
    ...
    public static function can($cap, $thow = true)
    {
        ...
        $currentInfo = (isset($info[$cap]) ? $info[$cap] : null);
        while ($currentInfo !== null) {
            ...
            $currentInfo = (isset($info[$currentInfo['parent']]) ? $info[$currentInfo['parent']] : null);
        }
